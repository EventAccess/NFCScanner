...
Electroniccats_PN7150 nfc(PN7150_IRQ, PN7150_VEN, PN7150_ADDR, &PN7150_WIRE);  // creates a global NFC device interface object, attached to pins 7 (IRQ) and 8 (VEN) and using the default I2C address 0x28
...
volatile bool __toggle = false;
void toggleLED() {
  __toggle = !__toggle;
  digitalWrite(LED_BUILTIN, __toggle);
}
...
void setup() {
  ...
  attachInterrupt(digitalPinToInterrupt(PN7150_IRQ), toggleLED, CHANGE);
